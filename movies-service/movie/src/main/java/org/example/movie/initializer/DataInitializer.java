package org.example.movie.initializer;
...
//        Genre genre3 = Genre.builder().name("Drama").build();
//        Genre genre4 = Genre.builder().name("Horror").build();
//        Genre genre5 = Genre.builder().name("Sci-Fi").build();
//
